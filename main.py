...
# Настройка MongoDB
app.config["MONGO_URI"] = "mongodb+srv://samyrize77777:BaTtlefield4@cluster0.ahmvu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # замените на вашу строку подключения
mongo = PyMongo(app)
